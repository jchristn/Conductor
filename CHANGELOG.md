...
- Added `LeastRecentlyUsed` as a virtual model runner load-balancing mode, with route-scoped recency tracking, eligibility screening, dashboard selection, MCP metadata, Postman coverage, REST documentation, and shared backend tests.
