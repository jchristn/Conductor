namespace Conductor.Core.Database.MySql.Implementations
{
    ...
    /// <summary>
    /// MySQL QoS profile methods implementation. A profile is persisted as an aggregate across the
    ...
    public class QosProfileMethods : IQosProfileMethods
    {
        ...
        /// <summary>
        /// Instantiate the MySQL QoS profile methods implementation.
        /// </summary>
        /// <param name="driver">Database driver. Must not be null.</param>
        public QosProfileMethods(MySqlDatabaseDriver driver)
        {
