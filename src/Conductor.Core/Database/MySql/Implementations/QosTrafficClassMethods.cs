namespace Conductor.Core.Database.MySql.Implementations
{
    ...
    /// <summary>
    /// MySQL QoS traffic class methods implementation.
    /// </summary>
    public class QosTrafficClassMethods : IQosTrafficClassMethods
    {
        ...
        /// <summary>
        /// Instantiate the MySQL QoS traffic class methods implementation.
        /// </summary>
        /// <param name="driver">Database driver. Must not be null.</param>
        public QosTrafficClassMethods(MySqlDatabaseDriver driver)
        {
