namespace Conductor.Core.Database.PostgreSql.Implementations
{
    ...
    /// <summary>
    /// PostgreSQL load-balancing policy methods implementation.
    /// </summary>
    public class LoadBalancingPolicyMethods : ILoadBalancingPolicyMethods
    {
        ...
        /// <summary>
        /// Instantiate the PostgreSQL load-balancing policy methods implementation.
        /// </summary>
        /// <param name="driver">Database driver.</param>
        public LoadBalancingPolicyMethods(PostgreSqlDatabaseDriver driver)
        {
