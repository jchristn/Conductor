    ...
    public static class TableQueries
    {
        ...
        public static readonly string CreateQosProfilesTable = @"
            CREATE TABLE IF NOT EXISTS qosprofiles (
                ...
                includeretryafter BOOLEAN NOT NULL DEFAULT TRUE,
        ...
        public static readonly string CreateQosQueueNodesTable = @"
            CREATE TABLE IF NOT EXISTS qosqueuenodes (
                ...
                wrrclassifiermode BOOLEAN NOT NULL DEFAULT FALSE,
                enableperclassmetrics BOOLEAN NOT NULL DEFAULT TRUE,
                enabletracing BOOLEAN NOT NULL DEFAULT TRUE,
                FOREIGN KEY (profileid) REFERENCES qosprofiles(id) ON DELETE CASCADE
            );
        ...
        public static readonly string CreateRequestHistoryTable = @"
            CREATE TABLE IF NOT EXISTS requesthistory (
                ...
                adaptiveselection BOOLEAN NOT NULL DEFAULT FALSE,
                policyfallbackused BOOLEAN NOT NULL DEFAULT FALSE,
