namespace Conductor.Core.Database.SqlServer.Implementations
{
    ...
    /// <summary>
    /// SQL Server load-balancing policy methods implementation.
    /// </summary>
    public class LoadBalancingPolicyMethods : ILoadBalancingPolicyMethods
    {
        ...
        /// <summary>
        /// Instantiate the SQL Server load-balancing policy methods implementation.
        /// </summary>
        /// <param name="driver">Database driver.</param>
        public LoadBalancingPolicyMethods(SqlServerDatabaseDriver driver)
        {
