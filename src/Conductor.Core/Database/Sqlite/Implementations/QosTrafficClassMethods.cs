namespace Conductor.Core.Database.Sqlite.Implementations
{
    ...
    /// <summary>
    /// SQLite QoS traffic class methods implementation.
    /// </summary>
    public class QosTrafficClassMethods : IQosTrafficClassMethods
    {
        ...
        /// <summary>
        /// Instantiate the SQLite QoS traffic class methods implementation.
        /// </summary>
        /// <param name="driver">Database driver. Must not be null.</param>
        public QosTrafficClassMethods(SqliteDatabaseDriver driver)
        {
