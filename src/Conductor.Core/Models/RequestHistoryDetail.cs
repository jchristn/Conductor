    ...
    public class RequestHistoryDetail : RequestHistoryEntry
    {
        ...
        public static RequestHistoryDetail FromEntry(RequestHistoryEntry entry)
        {
            ...
            return new RequestHistoryDetail
            {
                ...
                ModelAccessPolicyGuid = entry.ModelAccessPolicyGuid,
                ModelAccessPolicyName = entry.ModelAccessPolicyName,
                ModelAccessRuleGuid = entry.ModelAccessRuleGuid,
                ModelAccessRuleName = entry.ModelAccessRuleName,
                ModelAccessDecision = entry.ModelAccessDecision,
                ModelAccessWouldDeny = entry.ModelAccessWouldDeny,
                ...
                EndpointGroupGuid = entry.EndpointGroupGuid,
                EndpointGroupName = entry.EndpointGroupName,
                BackoffReason = entry.BackoffReason,
                AdaptiveSelection = entry.AdaptiveSelection,
                PolicyFallbackUsed = entry.PolicyFallbackUsed,
                DenialReasonCode = entry.DenialReasonCode,
                DenialReason = entry.DenialReason,
                ReservationGuid = entry.ReservationGuid,
                ReservationName = entry.ReservationName,
                ReservationDecision = entry.ReservationDecision,
                ReservationReasonCode = entry.ReservationReasonCode,
                ReservationWindowStartUtc = entry.ReservationWindowStartUtc,
                ReservationWindowEndUtc = entry.ReservationWindowEndUtc,
                ...
                TokensPerSecondOverall = entry.TokensPerSecondOverall,
                TokensPerSecondGeneration = entry.TokensPerSecondGeneration,
                AnalyticsCaptured = entry.AnalyticsCaptured,
                AnalyticsVersion = entry.AnalyticsVersion,
                DominantStageKind = entry.DominantStageKind,
                DominantStageDurationMs = entry.DominantStageDurationMs,
