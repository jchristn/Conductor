namespace Conductor.Core.ThirdParty.vLLM.Models
{
    ...
    /// <summary>
    /// vLLM generate chat completion request.
    /// </summary>
    public class vLLMGenerateChatCompletionRequest
    {
        /// <summary>
        ...
        public List<vLLMChatMessage> Messages { get; set; } = null;

        /// <summary>
        /// Response format specification.
        /// </summary>
        [JsonPropertyName("response_format")]
        public vLLMResponseFormat ResponseFormat { get; set; } = null;
        ...
        [JsonConverter(typeof(vLLMStopInputConverter))]
        ...
        public List<vLLMTool> Tools { get; set; } = null;
        ...
        /// vLLM generate chat completion request.
        /// </summary>
        public vLLMGenerateChatCompletionRequest()
        {
        }
    }
}
