namespace Conductor.Core.ThirdParty.vLLM.Models
{
    ...
    /// <summary>
    /// vLLM generate chat completion result.
    /// </summary>
    public class vLLMGenerateChatCompletionResult
    {
        /// <summary>
        ...
        public List<vLLMChatChoice> Choices { get; set; }
        ...
        /// </summary>
        public vLLMChatMessage GetAssistantMessage()
        {
        ...
        /// </summary>
        public List<vLLMToolCall> GetAllToolCalls()
        {
            return Choices?
                .Where(c => c.Message?.ToolCalls != null)
                .SelectMany(c => c.Message.ToolCalls)
                .ToList() ?? new List<vLLMToolCall>();
        }

        /// <summary>
        /// vLLM generate chat completion result.
        /// </summary>
        public vLLMGenerateChatCompletionResult()
        {
        }
    }
}
