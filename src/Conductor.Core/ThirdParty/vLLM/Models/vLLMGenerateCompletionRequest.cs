namespace Conductor.Core.ThirdParty.vLLM.Models
{
    ...
    public class vLLMGenerateCompletionRequest
    {
        ...
        [JsonConverter(typeof(vLLMPromptInputConverter))]
        ...
        /// vLLM generate completion request.
        /// </summary>
        public vLLMGenerateCompletionRequest()
        {
        }
    }
}
