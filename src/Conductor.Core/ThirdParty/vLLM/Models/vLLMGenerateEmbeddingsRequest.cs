namespace Conductor.Core.ThirdParty.vLLM.Models
{
    ...
    /// <summary>
    /// vLLM generate embeddings request.
    /// </summary>
    public class vLLMGenerateEmbeddingsRequest
    {
        /// <summary>
        ...
        [JsonConverter(typeof(vLLMEmbeddingsInputConverter))]
        public object Input
        {
            get => _Input;
            set => _Input = value;
        ...
        /// vLLM generate embeddings request.
        /// </summary>
        public vLLMGenerateEmbeddingsRequest()
        {
        }
    }
}
