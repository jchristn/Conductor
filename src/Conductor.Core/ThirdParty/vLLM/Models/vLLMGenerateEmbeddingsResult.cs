namespace Conductor.Core.ThirdParty.vLLM.Models
{
    ...
    /// <summary>
    /// vLLM generate embeddings result.
    /// </summary>
    public class vLLMGenerateEmbeddingsResult
    {
        /// <summary>
        ...
        public List<vLLMEmbedding> Data { get; set; }
        ...
        public vLLMEmbeddingUsage Usage { get; set; }
        ...
        /// vLLM generate embeddings result.
        /// </summary>
        public vLLMGenerateEmbeddingsResult()
        {
        }
    }
}
