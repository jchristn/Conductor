namespace Conductor.Core.ThirdParty.vLLM
{
    using System;
    ...
    using Conductor.Core.ThirdParty.vLLM.Models;
    using System.Net.Http;
    using RestWrapper;

    /// <summary>
    /// Client for interacting with vLLM-compatible API endpoints.
    /// </summary>
    public class vLLMClient
    {
        ...
        /// <summary>
        /// Instantiate the vLLM client.
        /// </summary>
        /// <param name="endpoint">vLLM API endpoint URL.</param>
        /// <param name="apiKey">API key for authentication (optional for some backends).</param>
        public vLLMClient(string endpoint, string apiKey = null)
        {
        ...
        public async Task<vLLMGenerateEmbeddingsResult> GenerateEmbeddingsAsync(
            vLLMGenerateEmbeddingsRequest request,
            CancellationToken token = default)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));

            string url = $"{_Endpoint}/v1/embeddings";
            return await PostAsync<vLLMGenerateEmbeddingsResult>(url, request, token).ConfigureAwait(false);
        }
        ...
        public async Task<vLLMGenerateCompletionResult> GenerateCompletionAsync(
            vLLMGenerateCompletionRequest request,
            CancellationToken token = default)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));
            ...
            return await PostAsync<vLLMGenerateCompletionResult>(url, request, token).ConfigureAwait(false);
        }
        ...
        public async IAsyncEnumerable<vLLMStreamingCompletionResult> GenerateCompletionStreamAsync(
            vLLMGenerateCompletionRequest request,
            [EnumeratorCancellation] CancellationToken token = default)
        {
            ...
            await foreach (vLLMStreamingCompletionResult result in PostStreamAsync<vLLMStreamingCompletionResult>(url, request, token))
            {
                yield return result;
            }
        }
        ...
        public async Task<vLLMGenerateChatCompletionResult> GenerateChatCompletionAsync(
            vLLMGenerateChatCompletionRequest request,
            CancellationToken token = default)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));
            ...
            return await PostAsync<vLLMGenerateChatCompletionResult>(url, request, token).ConfigureAwait(false);
        }
        ...
        /// <param name="token">Cancellation token.</param>
        /// <returns>Async enumerable of streaming results.</returns>
        public async IAsyncEnumerable<vLLMGenerateChatCompletionResult> GenerateChatCompletionStreamAsync(
            vLLMGenerateChatCompletionRequest request,
            [EnumeratorCancellation] CancellationToken token = default)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));
            ...
            await foreach (vLLMGenerateChatCompletionResult result in PostStreamAsync<vLLMGenerateChatCompletionResult>(url, request, token))
            {
                yield return result;
            }
        }
            ...
            [EnumeratorCancellation] CancellationToken token)
        {
            ...
            await foreach (string line in ReadLinesAsync(resp, token))
            {
                ...
                // vLLM streaming responses are prefixed with "data: "
