    ...
    public static class LoadBalancingPolicyCatalogProvider
    {
        private static readonly List<LoadBalancingMetricDefinition> _Metrics = new List<LoadBalancingMetricDefinition>
        {
            ...
            Metric("endpoint.maxParallelRequests", "Max Parallel Requests", "Static endpoint parallelism limit configured in Conductor.", "endpoint", LoadBalancingMetricValueTypeEnum.Number, true, true, "desc",
                LoadBalancingPolicyOperatorEnum.Equal, LoadBalancingPolicyOperatorEnum.NotEqual, LoadBalancingPolicyOperatorEnum.LessThan, LoadBalancingPolicyOperatorEnum.LessThanOrEqual, LoadBalancingPolicyOperatorEnum.GreaterThan, LoadBalancingPolicyOperatorEnum.GreaterThanOrEqual),
            Metric("runtime.backoffActive", "Runtime Backoff Active", "Whether adaptive runtime backoff is currently active for the endpoint.", "runtime", LoadBalancingMetricValueTypeEnum.Boolean, true, false, null,
                LoadBalancingPolicyOperatorEnum.Equal, LoadBalancingPolicyOperatorEnum.NotEqual),
            Metric("runtime.backoffRemainingMs", "Runtime Backoff Remaining", "Remaining transient backoff time in milliseconds.", "runtime", LoadBalancingMetricValueTypeEnum.Number, true, true, "asc",
                LoadBalancingPolicyOperatorEnum.Equal, LoadBalancingPolicyOperatorEnum.NotEqual, LoadBalancingPolicyOperatorEnum.LessThan, LoadBalancingPolicyOperatorEnum.LessThanOrEqual, LoadBalancingPolicyOperatorEnum.GreaterThan, LoadBalancingPolicyOperatorEnum.GreaterThanOrEqual),
            Metric("runtime.inFlight", "Runtime In-Flight", "Runtime-tracked requests currently in flight to this endpoint.", "runtime", LoadBalancingMetricValueTypeEnum.Number, true, true, "asc",
                LoadBalancingPolicyOperatorEnum.Equal, LoadBalancingPolicyOperatorEnum.NotEqual, LoadBalancingPolicyOperatorEnum.LessThan, LoadBalancingPolicyOperatorEnum.LessThanOrEqual, LoadBalancingPolicyOperatorEnum.GreaterThan, LoadBalancingPolicyOperatorEnum.GreaterThanOrEqual),
            Metric("runtime.pendingRequests", "Runtime Pending Requests", "Runtime-tracked requests admitted but not yet completed for this endpoint.", "runtime", LoadBalancingMetricValueTypeEnum.Number, true, true, "asc",
                LoadBalancingPolicyOperatorEnum.Equal, LoadBalancingPolicyOperatorEnum.NotEqual, LoadBalancingPolicyOperatorEnum.LessThan, LoadBalancingPolicyOperatorEnum.LessThanOrEqual, LoadBalancingPolicyOperatorEnum.GreaterThan, LoadBalancingPolicyOperatorEnum.GreaterThanOrEqual),
            Metric("runtime.pending", "Runtime Pending", "Alias for runtime pending requests.", "runtime", LoadBalancingMetricValueTypeEnum.Number, true, true, "asc",
                LoadBalancingPolicyOperatorEnum.Equal, LoadBalancingPolicyOperatorEnum.NotEqual, LoadBalancingPolicyOperatorEnum.LessThan, LoadBalancingPolicyOperatorEnum.LessThanOrEqual, LoadBalancingPolicyOperatorEnum.GreaterThan, LoadBalancingPolicyOperatorEnum.GreaterThanOrEqual),
            Metric("runtime.completedCount", "Runtime Completed Count", "Number of runtime-tracked requests completed by this endpoint since the latest stats reset.", "runtime", LoadBalancingMetricValueTypeEnum.Number, true, true, "desc",
                LoadBalancingPolicyOperatorEnum.Equal, LoadBalancingPolicyOperatorEnum.NotEqual, LoadBalancingPolicyOperatorEnum.LessThan, LoadBalancingPolicyOperatorEnum.LessThanOrEqual, LoadBalancingPolicyOperatorEnum.GreaterThan, LoadBalancingPolicyOperatorEnum.GreaterThanOrEqual),
            Metric("runtime.consecutiveFailures", "Runtime Consecutive Failures", "Current consecutive runtime failure count for this endpoint.", "runtime", LoadBalancingMetricValueTypeEnum.Number, true, true, "asc",
                LoadBalancingPolicyOperatorEnum.Equal, LoadBalancingPolicyOperatorEnum.NotEqual, LoadBalancingPolicyOperatorEnum.LessThan, LoadBalancingPolicyOperatorEnum.LessThanOrEqual, LoadBalancingPolicyOperatorEnum.GreaterThan, LoadBalancingPolicyOperatorEnum.GreaterThanOrEqual),
            Metric("runtime.successEwma", "Runtime Success EWMA", "Exponentially weighted moving average of recent runtime success, from 0 to 1.", "runtime", LoadBalancingMetricValueTypeEnum.Number, true, true, "desc",
                LoadBalancingPolicyOperatorEnum.Equal, LoadBalancingPolicyOperatorEnum.NotEqual, LoadBalancingPolicyOperatorEnum.LessThan, LoadBalancingPolicyOperatorEnum.LessThanOrEqual, LoadBalancingPolicyOperatorEnum.GreaterThan, LoadBalancingPolicyOperatorEnum.GreaterThanOrEqual),
            Metric("runtime.errorEwma", "Runtime Error EWMA", "Exponentially weighted moving average of recent runtime errors, from 0 to 1.", "runtime", LoadBalancingMetricValueTypeEnum.Number, true, true, "asc",
                LoadBalancingPolicyOperatorEnum.Equal, LoadBalancingPolicyOperatorEnum.NotEqual, LoadBalancingPolicyOperatorEnum.LessThan, LoadBalancingPolicyOperatorEnum.LessThanOrEqual, LoadBalancingPolicyOperatorEnum.GreaterThan, LoadBalancingPolicyOperatorEnum.GreaterThanOrEqual),
            Metric("runtime.latencyEwmaMs", "Runtime Latency EWMA", "Exponentially weighted moving average of recent total request latency in milliseconds.", "runtime", LoadBalancingMetricValueTypeEnum.Number, true, true, "asc",
                LoadBalancingPolicyOperatorEnum.Equal, LoadBalancingPolicyOperatorEnum.NotEqual, LoadBalancingPolicyOperatorEnum.LessThan, LoadBalancingPolicyOperatorEnum.LessThanOrEqual, LoadBalancingPolicyOperatorEnum.GreaterThan, LoadBalancingPolicyOperatorEnum.GreaterThanOrEqual),
            Metric("runtime.ttftEwmaMs", "Runtime TTFT EWMA", "Exponentially weighted moving average of recent time to first token in milliseconds.", "runtime", LoadBalancingMetricValueTypeEnum.Number, true, true, "asc",
                LoadBalancingPolicyOperatorEnum.Equal, LoadBalancingPolicyOperatorEnum.NotEqual, LoadBalancingPolicyOperatorEnum.LessThan, LoadBalancingPolicyOperatorEnum.LessThanOrEqual, LoadBalancingPolicyOperatorEnum.GreaterThan, LoadBalancingPolicyOperatorEnum.GreaterThanOrEqual),
