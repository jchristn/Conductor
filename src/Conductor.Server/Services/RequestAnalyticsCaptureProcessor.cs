    ...
    internal sealed class RequestAnalyticsCaptureProcessor
    {
            ...
            RequestProviderMetrics providerMetrics)
        {
            events.Add(new RequestAnalyticsEvent
            {
                ...
                ReservationGuid = detail.ReservationGuid,
                ReservationName = detail.ReservationName,
                ReservationDecision = detail.ReservationDecision,
                ReservationReasonCode = detail.ReservationReasonCode,
                ReservationWindowStartUtc = detail.ReservationWindowStartUtc,
                ReservationWindowEndUtc = detail.ReservationWindowEndUtc,
