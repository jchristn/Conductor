namespace Conductor.Server.Services
{
    ...
    public static class RequestTypeResolver
    {
        ...
        private static readonly Dictionary<RouteKey, RequestTypeEnum> _RouteMap = new()
        {
            ...
            { new RouteKey("POST", "/v1.0/modelrunnerendpoints/{id}/load-model"), RequestTypeEnum.LoadModelRunnerEndpointModel },
            { new RouteKey("GET", "/v1.0/modelrunnerendpoints/{id}/ollama/models"), RequestTypeEnum.ListOllamaEndpointModels },
            { new RouteKey("POST", "/v1.0/modelrunnerendpoints/{id}/ollama/models/pull"), RequestTypeEnum.PullOllamaEndpointModel },
            { new RouteKey("POST", "/v1.0/modelrunnerendpoints/{id}/ollama/models/delete"), RequestTypeEnum.DeleteOllamaEndpointModel },
            ...
            { new RouteKey("GET", "/v1.0/virtualmodelrunners/{id}/runtime-stats"), RequestTypeEnum.ReadVirtualModelRunnerRuntimeStats },
            { new RouteKey("POST", "/v1.0/virtualmodelrunners/{id}/runtime-stats/reset"), RequestTypeEnum.ResetVirtualModelRunnerRuntimeStats },
            { new RouteKey("POST", "/v1.0/virtualmodelrunners/{id}/runtime-backoff/clear"), RequestTypeEnum.ClearVirtualModelRunnerRuntimeBackoff },
