namespace Test.Shared.Core.Database
{
    ...
    public class RequestHistorySchemaTests
    {
        private static readonly string[] _DeferredIndexNames =
        {
            ...
            "idx_requesthistory_selectionstrategy",
            "idx_requesthistory_endpointgroupguid",
            "idx_requesthistory_backoffreason",
            "idx_requesthistory_adaptiveselection",
            "idx_requesthistory_policyfallbackused",
